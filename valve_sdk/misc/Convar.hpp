...
static auto CallVFuncC(void* thisptr, TArgs ... argList) -> TRet
{
...
public:
	Color GetColor()
	{
		return CallVFuncC<10, Color>(this);
	}

	const char* GetString()
	{
		return CallVFuncC<11, const char*>(this);
	}

	float GetFloat()
	{
		return CallVFuncC<12, float>(this);
	}

	int GetInt()
	{
		return CallVFuncC<13, int>(this);
	}

	void SetValue(const char *value)
	{
		CallVFuncC<14, void>(this, value);
	}

	void SetValue(float value)
	{
		CallVFuncC<15, void>(this, value);
	}

	void SetValue(int value)
	{
		CallVFuncC<16, void>(this, value);
	}

	void SetValue(Color value)
	{
		CallVFuncC<17, void>(this, value);
	}
